...
var RandomLevel = function () {
    ...
    this.createLevel = function(seed, xSize, zSize, ySize) {
        ...
        //this.progressRenderer.progressStart("世界生成中");
        //return;
        ...
        progress.string = "正在准备中..";
        //this.progressRenderer.progressStage("正在准备中..");
        ...
        progress.string = "正在挖洞..";
        //this.progressRenderer.progressStage("正在挖洞..");
        var aint1 = aint;
        ...
        progress.string = "正在渲染世界..";
        //this.progressRenderer.progressStage("正在渲染世界..");
        aint1 = aint;
        var j2 = this.xSize;
        var k2 = this.zSize;
        ...
        progress.string = "正在增加细节..";
        //this.progressRenderer.progressStage("正在增加细节..");
        ...
        progress.string = "正在生成水..";
        //this.progressRenderer.progressStage("正在生成水..");
        ...
        progress.string = "正在生成岩浆..";
        //this.progressRenderer.progressStage("正在生成岩浆..");
        this.melt();
        progress.string = "正在扩大..";
        //this.progressRenderer.progressStage("正在扩大..");
        this.grow(aint);
        progress.string = "正在种植植物..";
        //this.progressRenderer.progressStage("正在种植植物..");
        this.plant(aint);
